...
const About = () => {
  ...
  return (
    <div className="relative w-screen">
      <img src={wave} className="block w-full -mt-[1px]" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center gap-16">
        ...
        <div className="content w-full relative">
          <img
            src={man}
            className=" man w-[210px] absolute lg:-top-100 lg:right-50 md:-top-75 md:right-10 md:-top-[280px]"
          />

          <p className="text-[rgb(85,93,100)] text-2xl font-bold max-w-[460px] md:text-[15px] md:absolute md:top-5 lg:text-2xl lg:absolute lg:right-[200px] lg:-top-[100px]">
          ...
          <div className="flex gap-6 mt-8 md:absolute md:top-[80px] lg:absolute lg:right-[555px]">
        ...
        <img
          src={hand}
          className="hand absolute bottom-0 right-0 md:w-[130px] lg:w-[300px]"
        />
      </div>
    </div>
  );
